...
How to Run: You must start up a connection between the nodes and the server first. 
...
Node:Our messaging node extends our node interface, and starts off by connecting
